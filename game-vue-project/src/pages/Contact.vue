  ...
  <div>
    ...
    <div class="flex justify-between mx-60 my-10 ">
        ...
        <div class="flex flex-row">
          <a href="mailto:davide.farriciello@gmail.com" target="_blank" class="pi pi-envelope text-7xl text-red-700 hover:-translate-y-2 transition duration-300 ease-in-out"></a>
        </div>
        <div class="flex flex-row">
    ...
    <div class="flex flex-wrap justify-center p-5">
      <div
        ...
        <form class="flex flex-col px-4">
          <h2 class="text-5xl flex justify-center pb-7 font-bold text-gradient-from-fucsia"></h2>

          <input type="text" placeholder="Name" class="mb-3 p-4 rounded-lg outline-none">

          <input type="email" placeholder="Email" class="mb-3 p-4 rounded-lg w-full outline-none">

          <textarea placeholder="Message" rows="4" class="mb-3 p-4 rounded-lg w-full outline-none"></textarea>
