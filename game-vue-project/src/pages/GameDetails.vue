    ...
    <div>
      ...
      <div class="flex flex-col gap-10">
        <div class="flex flex-row gap-16">
          <img :src="game.pic1"
            class="h-fit w-96 rounded-md hover-shadow-red shadow-2xl transition-all duration-300 ease-in-out hover:scale-125">
          <img :src="game.pic2"
            class="w-96 h-fit rounded-md hover-shadow-red shadow-2xl transition-all duration-300 ease-in-out hover:scale-125">
        </div>
        <div class="flex flex-row gap-16">
          <img :src="game.pic3"
            class="w-96 h-fit rounded-md hover-shadow-red shadow-2xl transition-all duration-300 ease-in-out hover:scale-125">
