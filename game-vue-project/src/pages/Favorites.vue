<template>
  <div>
    <h2 class="text-5xl flex justify-center mt-10 font-bold text-gradient-from-fucsia">Favorites</h2>
        ...
        <div
          ...
          <div class="flex flex-col pl-6 mt-4">
            ...
            <div class="flex flex-row">
              <h2 class="text-3xl mt-1">Price: {{ item.price }}€</h2>
    ...
    <div v-else>
      <h2 class="text-5xl flex justify-center mt-10 text-gradient-from-fucsia">Any item is being added to the favorites</h2>
    </div>
  </div>
</template>
